...
local glc; do local cdecl = [[
	...
	typedef void (WINDOWS_STDCALL *_GLUfuncptr)();
	...
	typedef void (WINDOWS_STDCALL *GLDEBUGPROC)(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length,const GLchar *message,const void *userParam);
	...
	typedef void (WINDOWS_STDCALL *GLDEBUGPROCARB)(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length,const GLchar *message,const void *userParam);
	...
	typedef void (WINDOWS_STDCALL *GLDEBUGPROCAMD)(GLuint id,GLenum category,GLenum severity,GLsizei length,const GLchar *message,void *userParam);
	...
	]]; if require('ffi').os == 'Windows' then cdecl = cdecl:gsub('WINDOWS_STDCALL', '__attribute__((__stdcall__))') else cdecl = cdecl:gsub('WINDOWS_STDCALL', '') end; require('ffi').cdef(cdecl); glc = {
...
if ffi.os == "Windows" then
	...
	glu = ffi.load("glu32")
	glfw = ffi.load("../bin/glfw3")
else
	gl = ffi.load("GL")
	glu = ffi.load("GLU")
	glfw = ffi.load("../bin/glfw.so.3")
end
